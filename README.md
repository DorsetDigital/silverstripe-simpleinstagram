...
>
> This module relied on an unofficial Instagram feed integration. Changes to Instagram/Meta's APIs and access controls made that approach unreliable, and the module is no longer maintained. Existing users should replace it with an integration based on Meta's currently supported APIs.
